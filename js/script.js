  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function getDay(date) {
        ...
        const data = {
            ...
            "2024-06-30": [
                { time: '시간 : 00:00 - 02:00', course: '코스 : A코스', cost: '총 금액 : 170,000원'  },
                { time: '시간 : 00:00 - 02:00', course: '코스 : A코스', cost: '총 금액 : 190,000원'  },
                { time: '시간 : 00:00 - 02:00', course: '코스 : A코스', cost: '총 금액 : 80,000원'  }
            ],
            "2024-07-02": [
                { time: '시간 : 00:00 - 02:00', course: '코스 : A코스', cost: '총 금액 : 230,000원'  },
                { time: '시간 : 00:00 - 02:00', course: '코스 : B코스', cost: '총 금액 : 110,000원'  },
                { time: '시간 : 00:00 - 02:00', course: '코스 : D코스', cost: '총 금액 : 330,000원'  }
            ],
            "2024-07-05": [
                { time: '시간 : 00:00 - 02:00', course: '코스 : E코스', cost: '총 금액 : 70,000원'  },
                { time: '시간 : 00:00 - 02:00', course: '코스 : C코스', cost: '총 금액 : 230,000원'  },
                { time: '시간 : 00:00 - 02:00', course: '코스 : B코스', cost: '총 금액 : 160,000원'  }
            ]
        };
