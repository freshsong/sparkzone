...
--
-- Host: localhost    Database: golfproject
-- ------------------------------------------------------
...
CREATE TABLE `member` (
  ...
  `mem_repass` varchar(255) DEFAULT NULL,
  `mem_email` varchar(100) NOT NULL,
  `mem_phonenum` int DEFAULT NULL,
  `mem_role` enum('admin','member') NOT NULL,
  PRIMARY KEY (`mem_id`),
...
CREATE TABLE `notice` (
  ...
  `noti_hit` int DEFAULT '0',
  `noti_date` datetime NOT NULL,
  PRIMARY KEY (`noti_id`),
  UNIQUE KEY `noti_num` (`noti_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qna` (
  ...
  `qna_ques` text NOT NULL,
  `qna_answer` text,
  `qna_wdate` date NOT NULL,
  `qna_hit` int DEFAULT '0',
...
-- Dump completed on 2024-06-03 17:03:24
